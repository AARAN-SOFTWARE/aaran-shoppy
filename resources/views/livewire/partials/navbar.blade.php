    ...
    <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Global">
        <div class="relative md:flex md:items-center md:justify-between">
            <div class="flex items-center justify-between">
                <a class="flex items-center gap-1 text-xl font-semibold dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/" aria-label="Brand">
                    ...
                    <span class="bg-gradient-to-r from-[#FF321E] via-[#F7C028] to-[#FF321E] bg-clip-text text-transparent aaran-text px-1">AARAN</span>
                    <span class="text-[#82d2e8] shoppy-text ">Shoppy</span>
